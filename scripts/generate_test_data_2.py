...
import json
import os
from config_private import CONFIG_DATASET, CONFIG_SHOPPING_2,CONFIG_CLASSIFIEDS,CONFIG_CLASSIFIEDS_RESET_TOKEN,CONFIG_REDDIT,CONFIG_WIKIPEDIA,CONFIG_HOMEPAGE
...
def main() -> None:
    ...
    if DATASET == "webarena":
        ...
        inp_paths = [
            ...
            "config_files/vwa/test_shopping2.raw.json",
